...
#ifndef dds_gl_overlay_message_tPlugin_1587818003_h
#define dds_gl_overlay_message_tPlugin_1587818003_h
...
#define dds_gl_overlay_message_tPlugin_get_sample PRESTypePluginDefaultEndpointData_getSample 
#define dds_gl_overlay_message_tPlugin_return_sample PRESTypePluginDefaultEndpointData_returnSample 
#define dds_gl_overlay_message_tPlugin_get_buffer PRESTypePluginDefaultEndpointData_getBuffer 
#define dds_gl_overlay_message_tPlugin_return_buffer PRESTypePluginDefaultEndpointData_returnBuffer 
 

#define dds_gl_overlay_message_tPlugin_create_sample PRESTypePluginDefaultEndpointData_createSample 
#define dds_gl_overlay_message_tPlugin_destroy_sample PRESTypePluginDefaultEndpointData_deleteSample 

/* --------------------------------------------------------------------------------------
    Support functions:
 * -------------------------------------------------------------------------------------- */

NDDSUSERDllExport extern dds_gl_overlay_message_t*
...
dds_gl_overlay_message_tPluginSupport_copy_data(
    dds_gl_overlay_message_t *out,
    const dds_gl_overlay_message_t *in);
...
NDDSUSERDllExport extern RTIBool
dds_gl_overlay_message_tPlugin_skip(
    PRESTypePluginEndpointData endpoint_data,
    struct RTICdrStream *stream, 
...
NDDSUSERDllExport extern RTIBool 
dds_gl_overlay_message_tPlugin_deserialize_key_sample(
    PRESTypePluginEndpointData endpoint_data,
    dds_gl_overlay_message_t * sample,
    struct RTICdrStream *stream,
    RTIBool deserialize_encapsulation,
...
NDDSUSERDllExport extern RTIBool 
dds_gl_overlay_message_tPlugin_deserialize_key(
    PRESTypePluginEndpointData endpoint_data,
    dds_gl_overlay_message_t ** sample,
    RTIBool * drop_sample,
    struct RTICdrStream *stream,
...
dds_gl_overlay_message_tPlugin_new(void);

NDDSUSERDllExport extern void
dds_gl_overlay_message_tPlugin_delete(struct PRESTypePlugin *);
...
#endif /* dds_gl_overlay_message_tPlugin_1587818003_h */
