...
/* --------------------------------------------------------------------------------------
 *  Type dds_obstacle_map_message_t
 * -------------------------------------------------------------------------------------- */
...
dds_obstacle_map_message_tPluginSupport_create_data_ex(RTIBool allocate_pointers){
    dds_obstacle_map_message_t *sample = NULL;

    RTIOsapiHeap_allocateStructure(
        &sample, dds_obstacle_map_message_t);

    if(sample != NULL) {
        if (!dds_obstacle_map_message_t_initialize_ex(sample,allocate_pointers)) {
...
{
    return dds_obstacle_map_message_tPluginSupport_create_data_ex(RTI_TRUE);
}
...
dds_obstacle_map_message_tPluginSupport_destroy_data_ex(
    ...
    dds_obstacle_map_message_t_finalize_ex(sample,deallocate_pointers);
...
dds_obstacle_map_message_tPluginSupport_destroy_data(
    ...
    dds_obstacle_map_message_tPluginSupport_destroy_data_ex(sample,RTI_TRUE);
...
{
    return dds_obstacle_map_message_t_copy(dst,src);
}
    ...
    unsigned int indent_level)
{
    ...
    RTICdrType_printLongLong(
        &sample->utime, "utime", indent_level + 1);
    ...
    RTICdrType_printLong(
        &sample->num_rows, "num_rows", indent_level + 1);
            
    RTICdrType_printLong(
        &sample->num_cols, "num_cols", indent_level + 1);
            
    RTICdrType_printLong(
        &sample->map_r0, "map_r0", indent_level + 1);
            
    RTICdrType_printLong(
        &sample->map_c0, "map_c0", indent_level + 1);
            
    RTICdrType_printLong(
        &sample->array_r0, "array_r0", indent_level + 1);
            
    RTICdrType_printLong(
        &sample->array_c0, "array_c0", indent_level + 1);
    ...
    void *containerPluginContext)
{
    ...
    epd = PRESTypePluginDefaultEndpointData_new(
            ...
            dds_obstacle_map_message_tPluginSupport_create_data,
    ...
    if (endpoint_info->endpointKind == PRES_TYPEPLUGIN_ENDPOINT_WRITER) {
        if (PRESTypePluginDefaultEndpointData_createWriterPool(
            ...
            (PRESTypePluginGetSerializedSampleMaxSizeFunction)
                dds_obstacle_map_message_tPlugin_get_serialized_sample_max_size, epd,
...
dds_obstacle_map_message_tPlugin_copy_sample(
    ...
    const dds_obstacle_map_message_t *src)
{
    return dds_obstacle_map_message_tPluginSupport_copy_data(dst,src);
}
    ...
    void *endpoint_plugin_qos)
{
  ...
  if(serialize_sample) {
    ...
    if (!RTICdrStream_serializeFloat(
        stream, &sample->resolution)) {
        return RTI_FALSE;
    }
            
    if (!RTICdrStream_serializeLong(
        stream, &sample->num_rows)) {
        return RTI_FALSE;
    }
            
    if (!RTICdrStream_serializeLong(
        stream, &sample->num_cols)) {
        return RTI_FALSE;
    }
            
    if (!RTICdrStream_serializeLong(
        stream, &sample->map_r0)) {
        return RTI_FALSE;
    }
            
    if (!RTICdrStream_serializeLong(
        stream, &sample->map_c0)) {
        return RTI_FALSE;
    }
            
    if (!RTICdrStream_serializeLong(
        stream, &sample->array_r0)) {
        return RTI_FALSE;
    }
            
    if (!RTICdrStream_serializeLong(
        stream, &sample->array_c0)) {
        return RTI_FALSE;
    }
    ...
    void *endpoint_plugin_qos)
{
    ...
    return dds_obstacle_map_message_tPlugin_deserialize_sample( 
...
RTIBool dds_obstacle_map_message_tPlugin_skip(
    PRESTypePluginEndpointData endpoint_data,
    struct RTICdrStream *stream,   
    ...
    void *endpoint_plugin_qos)
{
    ...
    if(serialize_key) {
        ...
        if (!dds_obstacle_map_message_tPlugin_serialize(
                endpoint_data,
                sample,
                stream,
...
RTIBool dds_obstacle_map_message_tPlugin_deserialize_key_sample(
    PRESTypePluginEndpointData endpoint_data,
    dds_obstacle_map_message_t *sample, 
    struct RTICdrStream *stream,
    RTIBool deserialize_encapsulation,
    ...
    void *endpoint_plugin_qos)
{
    ...
    if (deserialize_key) {
        ...
        if (!dds_obstacle_map_message_tPlugin_deserialize_sample(
...
RTIBool dds_obstacle_map_message_tPlugin_deserialize_key(
    PRESTypePluginEndpointData endpoint_data,
    dds_obstacle_map_message_t **sample, 
    RTIBool * drop_sample,
    struct RTICdrStream *stream,
    ...
    void *endpoint_plugin_qos)
{
    return dds_obstacle_map_message_tPlugin_deserialize_key_sample(
    ...
    unsigned int current_alignment)
{
    ...
    current_alignment += dds_obstacle_map_message_tPlugin_get_serialized_sample_max_size(
...
struct PRESTypePlugin *dds_obstacle_map_message_tPlugin_new(void) 
{ 
    ...
    plugin->createSampleFnc =
        ...
        dds_obstacle_map_message_tPlugin_create_sample;
    plugin->destroySampleFnc =
        (PRESTypePluginDestroySampleFunction)
        dds_obstacle_map_message_tPlugin_destroy_sample;
    ...
    plugin->getSampleFnc =
        ...
        dds_obstacle_map_message_tPlugin_get_sample;
    plugin->returnSampleFnc =
        (PRESTypePluginReturnSampleFunction)
        dds_obstacle_map_message_tPlugin_return_sample;

    plugin->getKeyKindFnc =
        (PRESTypePluginGetKeyKindFunction)
        dds_obstacle_map_message_tPlugin_get_key_kind;
    ...
    */
    ...
    plugin->typeCode =  (struct RTICdrTypeCode *)dds_obstacle_map_message_t_get_typecode();
    ...
    plugin->getBuffer = 
        ...
        dds_obstacle_map_message_tPlugin_get_buffer;
    plugin->returnBuffer = 
        (PRESTypePluginReturnBufferFunction)
        dds_obstacle_map_message_tPlugin_return_buffer;
    plugin->getSerializedSampleSizeFnc =
        (PRESTypePluginGetSerializedSampleSizeFunction)
        dds_obstacle_map_message_tPlugin_get_serialized_sample_size;

    plugin->endpointTypeName = dds_obstacle_map_message_tTYPENAME;

    return plugin;
}

void
dds_obstacle_map_message_tPlugin_delete(struct PRESTypePlugin *plugin)
{
